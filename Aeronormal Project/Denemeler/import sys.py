...
class DroneApp(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Drone Görüntü ve Simüle Radar/Lidar Uygulaması")
    ...
    def update_image(self, cv_img):
        ...
        # Simulate radar and lidar data from the image
        radar_data, lidar_data = self.simulate_radar_lidar(cv_img)
        self.current_data = {'radar': radar_data, 'lidar': lidar_data}
    ...
    def simulate_radar_lidar(self, image):
        # Simulate radar data
    ...
    def update_plot(self):
        ...
        if data_point:
            ...
            theta = data_point['radar']['theta']
            r = data_point['radar']['r']
            self.ax_radar.plot(theta, r, color='b')
            self.ax_radar.set_title("Radar Verisi")

            # Lidar data visualization
            x = data_point['lidar']['x']
            y = data_point['lidar']['y']
            z = data_point['lidar']['z']

...
def simulate_battery():
    ...
    battery_level.set(f"Batarya seviyesi: {level}%")
    battery_temperature.set(f"Batarya sıcaklığı: {temperature}°C")
...
# Tkinter arayüzü
root = tk.Tk()
root.title("Batarya Yönetim Sistemi Simülasyonu")
...
battery_level_label = ttk.Label(root, textvariable=battery_level, font=('Helvetica', 14))
battery_level_label.grid(column=0, row=0, padx=10, pady=10)

battery_temperature_label = ttk.Label(root, textvariable=battery_temperature, font=('Helvetica', 14))
battery_temperature_label.grid(column=0, row=1, padx=10, pady=10)

battery_warning_label = ttk.Label(root, textvariable=battery_warning, font=('Helvetica', 12), foreground='red')
battery_warning_label.grid(column=0, row=2, padx=10, pady=10)

temperature_warning_label = ttk.Label(root, textvariable=temperature_warning, font=('Helvetica', 12), foreground='red')
temperature_warning_label.grid(column=0, row=3, padx=10, pady=10)

fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(8, 6))
canvas = FigureCanvasTkAgg(fig, master=root)
canvas.get_tk_widget().grid(column=1, row=0, rowspan=4, padx=10, pady=10)

...
class DroneSimulationApp:
    ...
    def draw_drone(self):
        self.drone = tk.Button(self.root, text="Drone", bg="blue", fg="white", font=("Arial", 12, "bold"))
        self.drone.place(x=self.drone_pos[0]*self.cell_size, y=self.drone_pos[1]*self.cell_size, width=self.cell_size, height=self.cell_size)
    ...
    def on_key_press(self, event):
        ...
        if self.is_valid_move(new_pos):
            ...
            self.drone.place(x=self.drone_pos[0]*self.cell_size, y=self.drone_pos[1]*self.cell_size)

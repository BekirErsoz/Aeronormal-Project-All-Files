...
class ServerApp:
    def __init__(self, root):
        ...
        self.text_area = scrolledtext.ScrolledText(self.root, height=15, width=70, wrap=tk.WORD, bg="light blue")
        self.text_area.pack(pady=10)

        self.start_button = tk.Button(self.root, text="Sunucuyu Başlat", command=self.start_server)
        self.start_button.pack(pady=10)

        self.stop_button = tk.Button(self.root, text="Bağlantıyı Durdur", command=self.stop_server)
